          ...
          child: Align(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                GestureDetector(
                    onTap: () {
                      BlocProvider.of<NavigationBloc>(context).add(NavigationEvents.MessagesClickEvent);
                    },
                    child: Text(
                        "Messages",
                        style: TextStyle(
                ...
                GestureDetector(
                    onTap: () {
                      BlocProvider.of<NavigationBloc>(context).add(NavigationEvents.UtilityClickEvent);
                    },
                    child: Text(
                        "Utility Bills",
                        style: TextStyle(
